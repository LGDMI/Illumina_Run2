...
shared.t.ns.relabun.Gr.rest <- colSums(shared.t.ns.relabun.Gr[9:281,2:257])
shared.t.ns.relabun.Gr.top8[9,2:257] <- shared.t.ns.relabun.Gr.rest
shared.t.ns.relabun.Gr.top8$Category[9] <- c("Other")


shared.t.ns.relabun.Gr.top8.R <- tidyr::gather(shared.t.ns.relabun.Gr.top8,key = "SampleName", value = "RelativeAbundance",2:257)
